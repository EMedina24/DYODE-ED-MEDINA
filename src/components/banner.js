...
<div className="w-full  relative ">
        ...
        <div className=" pb-10 h-full bg-gray-200 sm:bg-transparent text-green-900 w-full m-auto sm:mt-40 sm:w-auto sm:m-20 text-center sm:absolute z-50 sm:top-48 sm:right-80  top-0 ">
